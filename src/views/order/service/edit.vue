      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="推荐人名称：" prop="recommendUsername">
            <el-input v-model="forms.recommendUsername" placeholder="请输入推荐人名称" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="推荐人电话：" prop="recommendMobile">
            <el-input v-model="forms.recommendMobile" placeholder="请输入推荐人电话" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="折扣：" prop="discount">
            <el-input v-model="forms.discount" placeholder="请输入折扣" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="组织人名称：" prop="responsibleArrangeUserName">
            <el-input v-model="forms.responsibleArrangeUserName" placeholder="请输入组织人名称" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="服务备注：" prop="serviceRemark">
            <el-input v-model="forms.serviceRemark" placeholder="请输入服务备注" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
  ...
  methods: {
      ...
      if (that.orderId) {
        ...
        detailorder(that.orderId).then((response) => {
          ...
          that.forms = {
            ...
            bigareaId: data.bigareaId,
            cityId: data.cityId,
            districtId: data.districtId,
            cityName: data.cityName,
            doorServiceTime: data.doorServiceTime+":00",
            orderId: data.orderId,
            discount: data.discount,
            provinceId: data.provinceId,
            remark: data.remark,
            responsibleArrangePhone: data.responsibleArrangeMobile,
            responsibleArrangeUserId: data.responsibleArrangeUserId,
            responsibleArrangeUserName: data.responsibleArrangeUserName,
            serviceRemark: data.serviceRemark,
            distributeUsers: data.distributeUsers,
            distributeUsersuserName: '',
          }
          if(data.doorServiceTime==null){
            that.forms.doorServiceTime=""
          }
       
          //服务人员
          var distributeUsers = that.forms.distributeUsers
          if (
            distributeUsers != undefined &&
            distributeUsers != null &&
            distributeUsers != ''
          ) {
            ...
            that.forms.distributeUsers.forEach((row) => {
              ...
              that.forms.distributeUsers.push(i)
              that.ids.push(i)
              that.forms.distributeUsersuserName += row.arrangeUserName + ' '
            })
          }
        })
      }
    ...
    submitForm: function () { 
      ...
      this.$refs['forms'].validate((valid) => {
        if (valid) {
          updateOrder(this.forms).then((response) => {
