<template>
  <div class="app-container">
    <el-table v-loading="loading" :data="deptList">
      ...
      <el-table-column label="收藏内容" align="center" prop="favoriteId" />
      <!-- <el-table-column label="收藏数" align="center" prop="mobile" /> -->
...
<script>
import { getArticleList } from "@/api/system/userManagement/collection";
