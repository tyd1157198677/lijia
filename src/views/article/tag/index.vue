  ...
  <div class="app-container">
    ...
    >
      ...
      <el-row :gutter="10" class="mb16">
        <el-col :span="1.5">
          <el-button type="success" size="mini" plain icon="el-icon-plus" @click="handleAdd">新增</el-button>
        </el-col>
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签编码" align="center" prop="dictCode" />
      ...
      <el-table-column label="标签ID" align="center" prop="dictValue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="标签ID：" prop="dictValue">
          <el-input v-model="form.dictValue" placeholder="请输入标签ID" />
        </el-form-item>
