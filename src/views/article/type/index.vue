<template>
  <div class="app-container">
    <el-form
      ...
      v-show="showSearch"
    >
      <el-form-item label="分类：" prop="dictLabel">
        <el-input
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类编码" align="center" prop="dictCode" />
      <el-table-column label="分类" align="center" prop="dictLabel">
      ...
      <el-table-column label="分类ID" align="center" prop="dictValue" />
      <el-table-column label="分类排序" align="center" prop="dictSort" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="分类ID：" prop="dictValue">
          <el-input v-model="form.dictValue" placeholder="请输入分类ID" />
        </el-form-item>
