<template>
  <div class="app-container">
    <el-form class="formClass" :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" >
      ...
      <el-form-item label="任务组名：" prop="jobGroup">
        <el-select v-model="queryParams.jobGroup" placeholder="请选择任务组名" clearable size="mini">
          <el-option
