<template>
  <div>
    <div class="user-info-head" @click="editCropper()">
      <img v-if="options.img" v-bind:src="options.img" class="img-circle img-lg" />
      <img
        v-if="!options.img"
        src="https://oss-img.lijiazhengli.com//img/CQZD3K_1635237463301.png"
...
export default {
  ...
  created() {
    ...
    setTimeout(function () {
      if (_this.article.coverHtml) {
        _this.options.img = _this.article.coverHtml
        _this.thumbnailUrl = _this.article.coverHtml
      }
    }, 2000)
  },
  watch: {
